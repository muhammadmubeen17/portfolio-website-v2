...
export const experience = [
  ...
  },
  {
    ...
    company: "Cyber Hawks",
    description:
      "Developed and maintained backend systems using PHP and Laravel. Built RESTful APIs, managed MySQL databases, and collaborated with frontend teams on full-stack feature delivery.",
